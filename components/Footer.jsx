...
const socialLinks = [
  {
    href: 'https://www.instagram.com/andhrastore.india',
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-main py-10 md:py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-white text-sm font-bold mb-3">Shop</h3>
          ...
          <div>
            <h3 className="text-white text-sm font-bold mb-3">Company</h3>
            <ul className="space-y-2" role="list">
              {companyLinks.map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="text-xs text-gray-400 hover:text-brand-400 transition-colors">{l.label}</Link>
          ...
          <div>
            <h3 className="text-white text-sm font-bold mb-3">Get in Touch</h3>
            <address className="not-italic space-y-2 text-xs text-gray-400">
              <p>
                <a href="tel:+918758302568" className="hover:text-brand-400 transition-colors">📞 8758302568</a>
                {', '}
                <a href="tel:+918799114169" className="hover:text-brand-400 transition-colors">8799114169</a>
              </p>
              <p>
                <a href="mailto:Andhrastore.india@gmail.com" className="hover:text-brand-400 transition-colors">📧 Andhrastore.india@gmail.com</a>
              </p>
