...
export default function CartDrawer({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 bottom-0 w-full max-w-[420px] bg-white z-[151] shadow-2xl transition-transform duration-400 ease-[cubic-bezier(0.32,0.72,0,1)] ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-olive-600 text-white text-[10px] font-bold">0</span>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Empty state */}
        <div className="flex-1 flex flex-col items-center justify-center px-6" style={{ height: 'calc(100vh - 180px)' }}>
        ...
        {/* Footer (sticky, for when items exist) */}
