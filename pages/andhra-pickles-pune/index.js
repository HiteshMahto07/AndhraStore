...
const pageTitle = 'Andhra Pickles Delivery in Pune — Order Online | Andhra Store';
const pageDesc  = 'Order authentic Andhra pickles with delivery to Pune in 2 days. Mango Avakaya, Gongura Pachadi, Chicken Pickle and more. Made in Daman with no preservatives. Free shipping pan-India.';
...
const faqs = [
  { q: 'How long does delivery to Pune take?', a: 'Pune is about 330 km from our store in Nani Daman. Orders typically arrive in 2 business days via courier. We dispatch within 24 hours of confirmation.' },
  { q: 'Do you deliver to Pimpri-Chinchwad and Hinjewadi?', a: 'Yes — we deliver across Pune including Pimpri-Chinchwad, Hinjewadi, Baner, Wakad, Kothrud, Hadapsar and all other areas via courier.' },
  { q: 'Is there a minimum order value for Pune delivery?', a: 'No minimum order. You can order a single jar and it ships free.' },
  { q: 'Which pickle is most popular with Pune customers?', a: 'Chicken Pickle and Mango Avakaya are the most ordered in Pune. Gongura Pachadi gets regular reorders from customers who have moved from Andhra and Telangana.' },
  { q: 'Can I get a sampler to try before ordering more?', a: 'We do not have a fixed sampler pack but you can order any combination of jars. Ordering two or three varieties to try first is what most new customers do.' },
];
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Andhra Store",
  description: 'Authentic Andhra pickles handcrafted in Nani Daman, delivered to Pune.',
  url: pageUrl,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: 'Andhra Pickles in Pune', item: pageUrl },
  ],
};
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image:alt" content='Andhra pickles delivered in Pune — authentic homemade mango avakaya and more' />
      ...
      <section className="bg-gradient-to-br from-olive-800 via-olive-700 to-olive-900 text-white" aria-label="Pune city page hero">
        <div className="container-main py-12 md:py-20">
          <p className="text-[11px] font-bold text-olive-200 uppercase tracking-[0.2em] mb-2">Delivery to Pune</p>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold mb-4 max-w-2xl leading-tight">
            Authentic Andhra Pickles<br />Delivered to Pune
          </h1>
          <p className="text-olive-200 text-sm sm:text-base max-w-xl leading-relaxed mb-8">
            We make and ship from Nani Daman. Pune orders typically arrive in 2 business days. Mango Avakaya, Gongura, Chicken and 13 more varieties — all made without preservatives.
          </p>
      ...
      <div className="bg-olive-700 py-3">
        <div className="container-main grid grid-cols-2 md:grid-cols-4 gap-3 text-white text-xs">
          ...
          <div><p className="font-semibold">2 Business Days</p><p className="text-white/60">Pune — 330 km away</p></div>
      ...
      <section className="section-pad bg-white" aria-labelledby="products-heading">
        <div className="container-main">
          <SectionHeading label='Top Picks for Pune' title='Most Ordered Pickles in Pune'
      ...
      <section className="section-pad bg-cream" aria-labelledby="delivery-heading">
        <div className="container-main">
          <SectionHeading label="Delivery" title='Pune Delivery Info' id="delivery-heading" />
          <div className="grid sm:grid-cols-3 gap-4 mb-8">
            {[
              { title: 'Delivery Time',   value: '2 Business Days', sub: 'Daman to Pune — 330 km' },
              { title: 'Shipping Charge', value: 'Free', sub: 'On all orders to Pune' },
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            <p className="text-[11px] font-bold text-olive-600 uppercase tracking-wider mb-3">Areas We Deliver to in Pune</p>
      ...
      <section className="section-pad bg-white" aria-labelledby="why-heading">
        <div className="container-main">
          <SectionHeading label="Why Choose Us" title='Why Pune Customers Order from Andhra Store' id="why-heading" />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Made in Daman', desc: 'Our kitchen is in Nani Daman, not a factory in some distant city. Small operation, freshly made every week.' },
              { title: 'No Preservatives', desc: 'Cold-pressed groundnut oil, Guntur red chillies, rock salt. Nothing else. Shelf life comes from the oil and salt, not from additives.' },
              { title: 'Andhra Diaspora Favourite', desc: 'A large number of our Pune customers are Andhra or Telangana families settled in the city. They know what real avakaya should taste like — and they keep coming back.' },
              { title: 'Secure Packaging', desc: 'Jars are bubble-wrapped individually and packed in sturdy boxes. We have had very few breakages in transit over hundreds of Pune orders.' },
            ].map((w) => (
      ...
      <section className="section-pad bg-cream" aria-labelledby="reviews-heading">
        <div className="container-main">
          <SectionHeading label="Customer Reviews" title='What Pune Customers Say' id="reviews-heading" />
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { name: 'Suresh K.', loc: 'Baner, Pune', text: 'I am from Vijayawada, living in Pune for 6 years. The avakaya from Andhra Store is the closest I have found to what my mother makes at home. Ordered twice already.' },
              { name: 'Deepa M.', loc: 'Kothrud, Pune', text: 'The chicken pickle is really good. Strong flavour, proper Andhra spice level. Arrived in 2 days and the jar was well packed. Will order more for gifting.' },
              { name: 'Rohit S.', loc: 'Hinjewadi, Pune', text: 'Tried gongura and mango pickle together. Both excellent. The gongura sourness is exactly right not too sharp, not mild. Difficult to find this quality in Pune shops.' },
            ].map((t) => (
      ...
      <section className="section-pad bg-olive-800 text-white" aria-label="Order CTA">
        <div className="container-main text-center">
          ...
          <p className="text-olive-200 text-sm max-w-md mx-auto mb-6">Browse the full range and get authentic Andhra pickles delivered to your Pune address.</p>
