...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Andhra Store</title>
        <meta name="description" content="Learn how Andhra Store collects, uses, and protects your personal information." />
      </Head>
      <Header />

      <main className="bg-cream min-h-screen">
        {/* Hero */}
        <section className="bg-gradient-to-br from-olive-800 via-olive-700 to-olive-900 text-white py-16 md:py-24">
          <div className="container-main text-center">
            ...
            <p className="text-olive-200 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
              Your privacy matters to us. This policy explains how we collect, use, and protect your personal information when you use our website and services.
            </p>
        ...
        <section className="container-main py-12 md:py-16">
          <div className="max-w-3xl mx-auto space-y-8">
              ...
              return (
                <div key={idx} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-olive-50 border border-olive-100">
                  ...
                  <ul className="space-y-2.5">
                    {section.content.map((item, i) => (
                      <li key={i} className="flex items-start gap-2.5 text-sm text-gray-600 leading-relaxed">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-olive-400 flex-shrink-0" />
                        {item}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="bg-olive-50 border border-olive-200 rounded-2xl p-6 md:p-8 text-center">
              <h3 className="text-lg font-heading font-bold text-gray-900 mb-2">Questions about your privacy?</h3>
